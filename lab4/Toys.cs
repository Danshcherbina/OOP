...
{
    [Serializable]
    public class Toys : Product, ToyThings, ProductThings          //описание класса Игрушка
    {
        /// <summary>
        /// <para>User age</para>
        /// </summary>
        ...
        public Toys(string name, int price, string country)
            : base(name, price)
        {
            ToyCount += 1;
        ...
        public void breakIt()
        {
            Console.WriteLine("Urghhhh, {0} is broken...", this.name);
        }
    }

    [Serializable]
    public class CopyOfToys : Product, ToyThings, ProductThings          //описание класса Игрушка
    {
        /// <summary>
        /// <para>User age</para>
        /// </summary>
        ...
        /// <param name="price">Price</param>
        /// <param name="country">country</param>
        public CopyOfToys(string name, int price, string country)
            : base(name, price)
        {
            ToyCount += 1;
            this.country = country;
