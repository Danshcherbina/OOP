...
namespace ConsoleApplication1
{
    ...
    [Serializable]
    public class CopyOfProduce : Product, ProductThings                // Описание класса Продукт
    {
        /// <summary>
        /// <para>Total amount of products.</para>
        /// </summary>
        ...
        /// <param name="price">Price</param>
        /// <param name="packYear">packYear</param>
        public CopyOfProduce(string name, int price, string packYear)
            : base(name, price)
        {
            ProdCount += 1;
            this.packDate = packYear;
        ...
        /// <para>Get produce name</para>
        /// </summary>
        ///  <returns>CopyOfProduce name</returns>
        public string getProduceName()
        {
            return this.name;
        }
        ...
        /// <para>Get amount of produces</para>
        /// </summary>
        ///  <returns>CopyOfProduce amount</returns>
        public int getProdAmount()
        {
            return ProdCount;
        }
