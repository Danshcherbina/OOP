...
namespace ConsoleApplication1
{
    ...
    [Serializable]
    public class CopyOfСannedProduce : Produce, ProductThings        //описание класса консервы
    {
        /// <summary>
        /// <para>Shelf life.</para>
        /// </summary>
        ...
        /// <param name="packYear">packYear</param>
        /// <param name="weight">weight</param>
        public CopyOfСannedProduce(string name, int price, string packYear, double weight)
            : base(name, price, packYear)
        {
            this.weight = weight;
        }
